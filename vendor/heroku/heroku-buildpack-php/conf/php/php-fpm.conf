...
; prefix (/app/.heroku/php). This prefix can be dynamically changed by using the
...
[global]
; Pid file
; Note: the default prefix is /app/.heroku/php/var
; Default Value: none
;pid = run/php-fpm.pid
...
; - 'php_values'
; - 'php_admin_values'
; When not set, the global prefix (or /app/.heroku/php) applies instead.
...
slowlog = /tmp/heroku.php-fpm.${PORT}.www.slowlog
